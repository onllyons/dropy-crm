            ...
            <div class="flex-1 md:ml-64">
                ...
                <main class="p-4 md:p-6">
                    ...
                    <div class="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        <div class="mt-1 text-xs text-slate-500">Rows with missing/invalid <span class="font-semibold">file_path</span> or file missing on server. Total: {{ number_format((int) ($mediaPathProblemsCount ?? 0)) }}</div>
