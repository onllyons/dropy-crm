...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <x-seo-component title="subscriptionHistoryApp" />
        <x-style-head-dropy />
        <x-styles-datatables />
    </head>
    <body class="min-h-screen overflow-x-hidden bg-slate-50 text-slate-900">
        <div class="min-h-screen flex">
            ...
            <div class="flex-1 md:ml-64">
                <x-top-nav title="subscriptionHistoryApp" />

                <main class="p-4 md:p-6">
                    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        <h1 class="text-2xl font-semibold">subscriptionHistoryApp</h1>
                    </div>
                    ...
                    <div class="mt-6 rounded-2xl border border-slate-200 bg-white p-5">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            ...
                            <div class="text-xs text-slate-500">subscriptionHistoryApp table</div>
                        </div>
                        <div class="mt-3 overflow-x-auto">
                            <table id="subscriptionHistoryAppTable" class="min-w-full text-sm">
                                <thead>
        ...
        <script>
            $(document).ready(function () {
                $('#subscriptionHistoryAppTable').DataTable({
                    dom: 'lBfrtip',
                    responsive: true,
                    columnDefs: [
