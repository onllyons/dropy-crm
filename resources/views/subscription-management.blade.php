...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <x-seo-component title="subscriptionManagement" />
        <x-style-head-dropy />
        <x-styles-datatables />
    </head>
    <body class="min-h-screen overflow-x-hidden bg-slate-50 text-slate-900">
        <div class="min-h-screen flex">
            ...
            <div class="flex-1 md:ml-64">
                <x-top-nav title="subscriptionManagement" />

                <main class="p-4 md:p-6">
                    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        <h1 class="text-2xl font-semibold">subscriptionManagement</h1>
                    </div>
                    ...
                    <div class="mt-6 rounded-2xl border border-slate-200 bg-white p-5">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            ...
                            <div class="text-xs text-slate-500">subscriptionManagement table</div>
                        </div>
                        <div class="mt-3 overflow-x-auto">
                            <table id="subscriptionManagementTable" class="min-w-full text-sm">
                                <thead>
                                ...
                                <tbody class="divide-y divide-slate-100">
                                    ...
                                    @empty
                                        <tr>
                                            <td class="py-3 text-slate-500" colspan="6">No rows found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
        ...
        <script>
            $(document).ready(function () {
                $('#subscriptionManagementTable').DataTable({
                    dom: 'lBfrtip',
                    responsive: true,
                    columnDefs: [
